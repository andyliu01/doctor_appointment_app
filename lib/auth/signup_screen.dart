                            ...
                            Wrap(
                              ...
                              children:
                                ...
                                return ChoiceChip(
                                  ...
                                  label: Text(type),
                                  selected: isSelected,
                                  selectedColor: Color.fromARGB(255, 1, 123,
                                      68), // Background color when selected
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                              ...
                              borderSide: BorderSide(
                                color: Color.fromARGB(
                                    255, 1, 123, 68), // Green border color
                            ...
                            focusedBorder: OutlineInputBorder(
                              ...
                              borderSide: BorderSide(
                                color: Color.fromARGB(255, 1, 123,
                                    68), // Green border color when focused
                                width: 1.0, // Border width
                              ),
                            ),
                            enabledBorder: OutlineInputBorder(
                              ...
                              borderSide: BorderSide(
                                color: Color.fromARGB(255, 1, 123,
                                    68), // Green border color when not focused
                                width: 1.0, // Border width
                              ),
                            ),
                          ),
